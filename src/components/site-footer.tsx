        ...
        <>
            <footer className="py-6 md:px-8 md:py-0 border-t-2 bg-black">
                <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
                    <p className="text-balance text-center text-sm leading-loose text-muted-foreground md:text-left font-medium underline underline-offset-4">
                        ©️ 2025 Emerge AI, All rights reserved.
                    </p>
                    <div>
